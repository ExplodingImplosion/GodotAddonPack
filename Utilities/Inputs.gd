...
static func get_local_cached_input_count() -> int:
	return get_local_cached_inputs().size()
...
static func get_player_cached_input_count(id: int) -> int:
	return get_player_cached_inputs(id).size()
